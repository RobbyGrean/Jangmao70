...
namespace Khet70
{
    internal static class Khet70ShellProgram
    {
        [STAThread]
        private static void Main()
        {
            ...
            Application.Run(new Khet70ShellForm());
        }
    }

    internal sealed class Khet70ShellForm : Form
    {
        ...
        private Form CreateLegacyPayrollForm()
        {
            ...
            var templateRoot = Khet70Paths.EnsureUserTemplateRoot(DocumentModule.Payroll);
            if (templateBox != null) templateBox.Text = templateRoot;
            if (outputBox != null) outputBox.Text = Khet70Paths.OutputRoot(DocumentModule.Payroll);
            return form;
        }
        ...
        private void HandleFormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            var choice = MessageBox.Show("มีข้อมูลที่ยังไม่ได้บันทึก ต้องการบันทึกก่อนปิดหรือไม่?\nใช่ = บันทึก, ไม่ใช่ = ไม่บันทึก, ยกเลิกหรือกากบาท = กลับไปทำงาน", "ปิด Khet70", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
