...
$sourceFiles = @((Join-Path $root 'Shared\Document346Core.cs'), (Join-Path $root 'Shared\TemplateTransfer.cs'), (Join-Path $root 'ReimbursementDocApp346.cs'), (Join-Path $root 'PayrollRendererSmokeTest.cs'))
