...
namespace ReimbursementDocApp
{
    ...
    internal sealed class ProcurementModule : UserControl
    {
        ...
        private Document346StoreData storeData;
        ...
        public ProcurementModule(WorkingRecord sharedRecord, Action sharedChangedCallback)
        {
            ...
            catch (Document346StoreException ex)
            {
                storeData = new Document346StoreData();
        ...
        {
            var path = Path.Combine(Document346Paths.ShippedConfigRoot(DocumentModule.Procurement), "template_manifest.json");
        ...
        private void LoadCatalog()
        {
            ...
            var catalog = Document346Config.Load<ProcurementPositionCatalog>(path);
        ...
        private void GenerateDocuments()
        {
            ...
            var templateRoot = Document346Paths.EnsureUserTemplateRoot(DocumentModule.Procurement);
            var outputRoot = Document346Paths.OutputRoot(DocumentModule.Procurement);
            ...
            try
            {
                ...
                {
                    var source = Document346Paths.ResolveUnder(templateRoot, relative);
                    ...
                    created.Add(Document346DocxRenderer.Render(source, requested, values));
                }
            }
            catch (Exception ex)
            {
