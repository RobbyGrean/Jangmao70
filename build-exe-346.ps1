...
& $csc /codepage:65001 /target:winexe /platform:anycpu /main:ReimbursementDocApp.Document346ShellProgram /win32icon:"$PSScriptRoot\app-icon.ico" /out:"$outDir\Jangmao70.exe" /reference:System.Windows.Forms.dll /reference:System.Drawing.dll /reference:System.IO.Compression.dll /reference:System.IO.Compression.FileSystem.dll /reference:System.Web.Extensions.dll $sourceFiles
