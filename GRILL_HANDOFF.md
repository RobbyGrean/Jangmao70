...
| D03 | SUPERSEDED | ค่าเริ่มต้นชื่อเขตคือ `สำนักงานเขตพื้นที่การศึกษาประถมศึกษาแม่ฮ่องสอน เขต 2`; ผู้ใช้เขตอื่นพิมพ์แก้ไขในช่องเขตได้เอง และไม่แสดงรายชื่อเขตอื่นเป็นตัวเลือกตั้งต้น | 2026-09-09 / คำสั่งผู้ใช้หลัง review | T02/T04: district preset และ normalization |
...
- อัปเดต D03 2026-09-09: คำสั่งผู้ใช้หลัง review ให้ลบรายการเขตอื่นออก เหลือ preset `สำนักงานเขตพื้นที่การศึกษาประถมศึกษาแม่ฮ่องสอน เขต 2` และคงช่องเขตแบบพิมพ์แก้ไขได้สำหรับผู้ใช้เขตอื่น
